...
import diacheck.java.libs.imageTools.test.EdgeDetectorTest;
...
@RunWith(Suite.class)
@SuiteClasses({ TriangleTest.class, ImageReaderTest.class, ImageValidatorTest.class, FieldTest.class, ImageTransformerTest.class, FieldFinderTest.class, ControlFieldReaderTest.class, EdgeDetectorTest.class, IntergrationTest.class })
