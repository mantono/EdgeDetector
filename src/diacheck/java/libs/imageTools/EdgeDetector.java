...
public class EdgeDetector
{
	...
	public Set<Point> createSobelSquareForPoint(final Point point)
	{
		final HashSet<Point> points = new HashSet<Point>(8);
	 ...
	 *         than the threshold value, or if the sum of all color channels
	 *         differences is greater than two times the threshold value. If
